...
package com.worlize.websocket
{
	...
	import com.dukascopy.connect.sys.ws.IWebSocket;
...
import flash.net.Socket;
	...
	public class WebSocket extends EventDispatcher implements IWebSocket
	{
		...
		private function init():void {
			...
			socket.addEventListener(Event.CLOSING, handleSocketClosing);
		...
		private function handleSocketClosing(event:Event):void {
			if (debug == true) {
				logger("Socket Disconnected");
			}
			trace();
		...
		private function handleSocketIOError(event:Event):void {
			if (debug) {
