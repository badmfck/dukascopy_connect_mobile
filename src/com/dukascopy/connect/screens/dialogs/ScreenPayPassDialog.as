package com.dukascopy.connect.screens.dialogs {
	...
	public class ScreenPayPassDialog extends ScreenAlertDialog {
		...
		public function ScreenPayPassDialog() {
			super();
		}
		...
		override protected function getMaxContentHeight():Number {
			return _height - padding * 4 - headerHeight - buttonsAreaHeight;
		}
