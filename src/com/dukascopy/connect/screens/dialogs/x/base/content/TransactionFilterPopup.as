package com.dukascopy.connect.screens.dialogs.x.base.content 
{
	...
	public class TransactionFilterPopup extends BottomPopup
	{
		...
		private function initDataset():void {
			...
			filter = new FilterData(Lang.filter_pending, new FinanceFilterType(FinanceFilterType.PENDING), Filter_pending, 0xe6a446);
				categoryStatus.add(filter);
			filter = new FilterData(Lang.filter_cancelled, new FinanceFilterType(FinanceFilterType.CANCELLED), Filter_cancelled, 0xcd3f43);
				categoryStatus.add(filter);
