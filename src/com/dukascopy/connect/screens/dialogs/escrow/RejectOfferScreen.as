package com.dukascopy.connect.screens.dialogs.escrow {
	...
	public class RejectOfferScreen extends EscrowDealScreen {
		...
		public function RejectOfferScreen() { }
		...
		{
			if ("callback" in data && data.callback != null && data.callback is Function && (data.callback as Function).length == 1)
			{
				(data.callback as Function)(escrowOffer);
				escrowOffer = null;
			}
		}
