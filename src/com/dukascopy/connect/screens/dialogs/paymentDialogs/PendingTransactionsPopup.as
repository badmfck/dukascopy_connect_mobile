package com.dukascopy.connect.screens.dialogs.paymentDialogs 
{
	...
	import com.dukascopy.connect.gui.list.renderers.PendingTransactionsRenderer;
	 ...
	 */
	public class PendingTransactionsPopup extends DialogBaseScreen
	{
		...
		private var transactions:Vector.<TransactionData>;
		private var list:List;
		
		public function PendingTransactionsPopup()
		{
		...
		override public function initScreen(data:Object = null):void
		{
			...
			if (data != null)
			{
				titleValue = Lang.pendingTransactions;
				...
				if ("items" in data)
				{
					transactions = data.items as Vector.<TransactionData>;
				}
			}
			...
			list.setData(transactions, PendingTransactionsRenderer);
