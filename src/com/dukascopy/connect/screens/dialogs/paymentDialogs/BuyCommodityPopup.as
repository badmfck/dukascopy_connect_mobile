package com.dukascopy.connect.screens.dialogs.paymentDialogs 
{
	...
	public class BuyCommodityPopup extends FloatPopup {
		...
		private static function generateCallID(prefix:String):String {
			c++; 
			return c +"" + prefix as String;
		}
		...
		private function onCommissionLoadingStateChange():void{
			...
			if (_isLoadingCommission){
				...
				if (latestCommissionData != null){
					...
					hidePreloader();
					if (targetInvestment == true)
					{
						iAmountCurrency.value = latestCommissionData.debit;
						
					}
					else{
						iAmount.value = latestCommissionData.credit;
					}
					if (commodity != null)
					{
