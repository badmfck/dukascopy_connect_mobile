package com.dukascopy.connect.screens.dialogs.paymentDialogs 
{
	...
	public class SendCoinsByPhonePopup extends BaseScreen {
		...
		public function SendCoinsByPhonePopup() {
		...
		override protected function createView():void {
			...
			container.addChild(inptCodeAndPhone.view);
		...
		private function drawSendTitle():void 
		{
			...
			if (userName != null)
			{
				...
				{
					value = Lang.transferCoinsToPhoneNumber;
				}
				else
				{
