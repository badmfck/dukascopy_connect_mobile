		...
		static public function handlePacket(pack:Object):void {
			...
			if (pack.method == WSMethodType.ESCROW_EVENT)
			{
				...
				/*evEscrow {
				  deal: {
					side: 'BUY',
					created_at: '2021-07-14 11:01:02',
					updated_at: '2021-07-14 11:01:02',
					status: 'created',
					instrument: 'btc',
					mca_ccy: 'eur',
					crypto_user_uid: 'WIDzWhWRWlW3',
					mca_user_uid: 'WdW6DJWbW3IcWm',
					chat_uid: 'WADWWsIGWhWh',
					msg_id: 35648941,
					crypto_trn_id: null,
					mca_trn_id: null,
				  ...
				  event: {
					created_at: '2021-07-14 11:01:02',
					created_at_inv: 1626260462978,
					type: 'deal_created',
					type_id: null,
					info: 'Generated by WSS API',
					created_by: 'pFcvIFn'
				  }
				}*/
