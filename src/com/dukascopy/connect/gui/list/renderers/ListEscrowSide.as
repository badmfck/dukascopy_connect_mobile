package com.dukascopy.connect.gui.list.renderers {
	 ...
	 * @author IgorBloom
	 */
	public class ListEscrowSide extends BaseRenderer implements IListRenderer {
		...
		public function ListEscrowSide() {
		...
		public function getView(li:ListItem, h:int, width:int, highlight:Boolean = false):IBitmapDrawable {
			...
			if(li.data != null){
				...
				if ("name" in li.data == true)
					tfLabel.text = li.data.name as String;
